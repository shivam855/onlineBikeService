	...
	out.println("</table>");
	pst.execute(); 	
	out.println("<h3><b>Give Approval for this Id <a href='mappingCE.jsp'>User Id</a></b></h3>");	
	out.println("<h3><b>Unmapped Service Engineer Id <a href='unmapping1.jsp'>User Id</a></b></h3>");	
	rs.close();
	pst.close();
 }
catch(Exception e){
